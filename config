...
bindsym $mod+d exec rofi -show run -lines 3 -eh 2 -width 100 -padding 450 -opacity "85" -bw "#2f343f" -bc "#2f343f" -bg "#2f343f" -fg "$text-color" -hlbg "#2f343f" -hlfg "#2f343f" -font "Roboto-Light 18"
